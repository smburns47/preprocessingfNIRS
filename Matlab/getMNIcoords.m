...
mni_refs = [61.9958,-15.6227,-34.411;   %RPA
            2.32,62.34,-21.85;          %Nz
            0.882,-13.4729,74.1371;     %Cz
            -60.6623,-15.935,-34.9223;  %LPA
            -4.77,-100.26,-14.39];      %Iz
...
digpts = table2array(digpts(:,2:4));
digpts_refs = digpts(end-4:end,:);
